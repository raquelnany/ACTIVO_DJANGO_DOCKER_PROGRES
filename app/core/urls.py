...
urlpatterns = [
    ...
    path('v1/parte_estatus/', views.views.ParteEstatusview.as_view()),
    path('v1/parte_estatus/<int:id_parte_estatus>', views.views.ParteEstatusview.as_view()), 
    path('v1/inventario_ajustes/', views.views.InventarioAjusteview.as_view()),
    path('v1/inventario_ajustes/<int:id_inventario_ajuste>', views.views.InventarioAjusteview.as_view()),
    path('v1/parte_detalles/', views.views.ParteDetalleview.as_view()),
    path('v1/parte_detalles/<int:id_parte_detalle>', views.views.ParteDetalleview.as_view()),  
    path('v1/devoluciones/', views.views.Devolucionview.as_view()),
    path('v1/devoluciones/<int:id_devolucion>', views.views.Devolucionview.as_view()), 
    path('v1/almacenes/', views.views.Almacenview.as_view()),
    path('v1/almacenes/<int:id_almacen>', views.views.Almacenview.as_view()), 
    path('v1/orden_trabajo_tipos/', views.views.OrdenTrabajoTipoview.as_view()),
    path('v1/orden_trabajo_tipos/<int:id_orden_trabajo_tipo>', views.views.OrdenTrabajoTipoview.as_view()), 
    path('v1/inventario_vales/', views.views.InventarioValeview.as_view()),
    path('v1/inventario_vales/<int:id_inventario_vale>', views.views.InventarioValeview.as_view()), 
    path('v1/partes_detalle_surtido/', views.views.ParteDetalleSurtidoview.as_view()),
    path('v1/partes_detalle_surtido/<int:id_parte_detalle_surtido>', views.views.ParteDetalleSurtidoview.as_view()), 
]
